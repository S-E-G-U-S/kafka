...
@Service
public class CompleteTaxiCallOperationUseCase {
    ...
    @Transactional
    public void completeOperationCall(long operationCallId, long driverId) {
        ...
        operationCall.completeRide(completeTime);
        ...
        var event = new TaxiRideStatusRecord(
                ...
                TaxiRideStatusRecord.Status.COMPLETE_RIDE,
                completeTime
        );
